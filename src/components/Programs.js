    ...
    return (
        <div className="programs-div bg-stone-50 pr-5 mb-[-8rem]">
            ...
            <div className="join-title text-center pt-20">
                <h1 className="join-title text-5xl font-bold text-olive">A Journey of Growth and Faith</h1>
            </div>

            <div className="programs-text">
                <h1 className="programs-subtext text-base font-semibold text-navy mt-2 text-center pb-10 pl-10">
                ...
                {/* Programs Section */}
                <div className="programs-text-div flex justify-center space-x-8 pl-9 mb-10 pt-20 pb-40">
                    <div className="program-li-div text-center">
                        ...
                        <img rel="preload" src="/assets/photos/HFH00142.jpg" alt="placeholder" className="program-li-img-one mb-4 h-2/5 rounded-xl translate-x-full mx-[-8.5rem]"/>
                        <h2 className="program-li-text text-default text-gray-700">Our infant program provides a loving and secure environment where your baby can thrive. With a focus on nurturing and sensory exploration, our caregivers foster your child’s cognitive, physical, and emotional growth.</h2>
                    </div>

                    <div className="program-li-div-two text-center transform translate-y-[-80px]">
                        ...
                        <img rel="preload" src="/assets/photos/HFH05001.jpg" alt="placeholder" className="program-li-img-two mb-4 h-2/5 rounded-xl translate-x-full mx-[-8.5rem]"/>
                        <h2 className="program-li-text text-default text-gray-700">For our curious toddlers, we create opportunities for hands-on discovery and skill development. Our activities include art, music, language building, and gross motor play to encourage their growing independence and creativity.</h2>
                    </div>
