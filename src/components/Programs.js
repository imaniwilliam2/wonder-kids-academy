            ...
            <div className="programs-text">
                ...
                <div className="flex justify-center space-x-8 pl-9 mb-10 pt-20 pb-40">
                    <div className="text-center">
                        ...
                        <img rel="preload" src="/assets/photos/HFH00142.jpg" alt="placeholder" className="mb-4 h-2/5 rounded-xl translate-x-full mx-[-8.5rem]"/>
                    ...
                    <div className="text-center transform translate-y-[-80px]">
                        ...
                        <img rel="preload" src="/assets/photos/HFH05001.jpg" alt="placeholder" className="mb-4 h-2/5 rounded-xl translate-x-full mx-[-8.5rem]"/>
                    ...
                    <h1 className="text-base font-bold text-olive inline-block border-2 border-navy/50 p-2 bg-stone-200 hover:shadow-lg hover:-translate-y-1 transition duration-300 ease-in-out mb-5">Preschool (3 - 4 years)</h1>
                        <img rel="preload" src="/assets/photos/HFH00148.jpg" alt="placeholder" className="mb-4 mx-auto h-2/5 rounded-xl mx-[-8.5rem]"/>
