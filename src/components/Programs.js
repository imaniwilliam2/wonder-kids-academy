    ...
    return (
        <div className="bg-stone-50">
            ...
            <div className="programs-text">
                ...
                {/* Programs Section */}
                <div class="flex justify-center space-x-8 pl-9 mb-10 pt-20 pb-10">
                    <div class="text-center">
                        <h1 class="text-xl font-bold text-olive inline-block border-2 border-navy/50 p-2 bg-stone-200 hover:shadow-lg hover:-translate-y-1 transition duration-300 ease-in-out">Infants (6 weeks - 12 months)</h1>
                    ...
                    <div class="text-center transform translate-y-[-80px] pl-10">
                        <h1 class="text-xl font-bold text-olive inline-block border-2 border-navy/50 p-2 bg-stone-200 hover:shadow-lg hover:-translate-y-1 transition duration-300 ease-in-out">Toddlers (1 - 2 years)</h1>
                        <img src="/assets/photos/placeholder.jpg" alt="placeholder" class="mb-4 mx-auto pt-5"/>
                    ...
                    <div class="text-center">
                    <h1 class="text-xl font-bold text-olive inline-block border-2 border-navy/50 p-2 bg-stone-200 hover:shadow-lg hover:-translate-y-1 transition duration-300 ease-in-out">Preschool (3 - 4 years)</h1>
                        <img src="/assets/photos/placeholder.jpg" alt="placeholder" class="mb-4 mx-auto pt-5"/>
